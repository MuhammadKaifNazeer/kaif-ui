  ...
  },
  {
    ...
    links: [
      ...
      { title: "Animated Tooltip", href: "/components/animated-tooltip" },
      {
        ...
        href: "/components/apple-cards-carousel",
      },
      ...
      { title: "Background Beams", href: "/components/background-beams" },
      {
        ...
        href: "/components/background-beams-with-collision",
      },
      ...
      { title: "Bento Grid", href: "/components/bento-grid" },
      {
        ...
        href: "/components/canvas-reveal-effect",
      },
      { title: "Card Hover Effect", href: "/components/card-hover-effect" },
      { title: "Card Spotlight", href: "/components/card-spotlight" },
      { title: "Card Stack", href: "/components/card-stack" },
      { title: "Cards", href: "/components/cards" },
      { title: "Compare", href: "/components/compare" },
      { title: "Container Cover", href: "/components/container-cover" },
      {
        title: "Container Scroll Animation",
        href: "/components/container-scroll-animation",
      },
      {
        title: "Direction Aware Hover",
        href: "/components/direction-aware-hover",
      },
      ...
      { title: "Glowing Stars", href: "/components/glowing-stars-effect" },
    ],
  },
  {
    title: "Explore More",
