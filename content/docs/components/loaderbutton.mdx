...
<TypeTable
  type={{
    isLoading: {
      description:
        "A boolean indicating whether the loader animation should be displayed.",
      type: "boolean",
      default: "false",
    },
    className: {
    ...
    buttonVariant: {
      description:
        "Defines the style variant of the button, can be one of the provided Tailwind-based variants like 'default', 'destructive', etc.",
    ...
    onClick: {
      description:
        "Optional onClick event handler that gets triggered when the button is clicked.",
