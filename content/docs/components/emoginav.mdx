...
<div className="space-y-2 mb-4">
 <h1 class="scroll-m-20 text-4xl font-bold tracking-tight text-black dark:text-white">Emogi Nav</h1>
 <p class="text-lg text-muted-foreground">Scroll through the page and see the image come out of the screen.</p>
</div>
...
<h1 class="scroll-m-20 text-xl font-bold tracking-tight text-black dark:text-white my-4">Tech Stack</h1>
